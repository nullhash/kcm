...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kcm.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".kcm" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".kcm")
	}
